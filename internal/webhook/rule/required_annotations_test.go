...
func TestRequiredAnnotations(t *testing.T) {
	...
	res := rule.RequiredAnnotations(&review, "file://../../../example/required_annotations/required_annotations.conf", "file://../../../example/required_annotations/required_annotations.csv")
	if res == nil {
